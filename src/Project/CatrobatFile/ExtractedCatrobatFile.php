...
class ExtractedCatrobatFile
{
  ...
  {
    $this->getHeader()->programName = TextSanitizer::sanitize($name) ?? $name;
  }
  ...
  {
    $this->getHeader()->description = TextSanitizer::sanitize($description) ?? $description;
  }
  ...
  {
    $this->getHeader()->notesAndCredits = TextSanitizer::sanitize($notesAndCredits) ?? $notesAndCredits;
  }
