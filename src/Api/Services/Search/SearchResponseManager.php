...
final class SearchResponseManager extends AbstractResponseManager
{
    ...
    function getSearchResponse(array $projects_response, array $users_response): SearchResponse
    {
    ...
    function getUsersSearchResponse(array $users, $total): array
    {
        $users_data_response = [];
    ...
    function getBasicUserDataResponse(User $user): BasicUserDataResponse
    {
    ...
    function getProjectsSearchResponse(array $projects, $total): array
    {
    ...
    function getProjectDataResponse($program): ProjectResponse
    {
        /** @var Program $project */
