...
class ModerationController extends Controller
{
   ...
   * @return Response the Symfony response
   */
  public function projectsIdAppealPostAction(Request $request, $id): Response
  {
    // Make sure that the client is providing something that we can consume
    $consumes = ['application/json'];
    if (!static::isContentTypeAllowed($request, $consumes)) {
    ...
    try {
      ...
      $handler->projectsIdAppealPost($id, $content_appeal_request, $responseCode, $responseHeaders);
   ...
   * @return Response the Symfony response
   */
  public function projectsIdReportPostAction(Request $request, $id): Response
  {
    // Make sure that the client is providing something that we can consume
    $consumes = ['application/json'];
    if (!static::isContentTypeAllowed($request, $consumes)) {
   ...
   * @return Response the Symfony response
   */
  public function studiosIdAppealPostAction(Request $request, $id): Response
  {
    // Make sure that the client is providing something that we can consume
    $consumes = ['application/json'];
    if (!static::isContentTypeAllowed($request, $consumes)) {
    ...
    try {
      ...
      $handler->studiosIdAppealPost($id, $content_appeal_request, $responseCode, $responseHeaders);
   ...
   * @return Response the Symfony response
   */
  public function studiosIdReportPostAction(Request $request, $id): Response
  {
    // Make sure that the client is providing something that we can consume
    $consumes = ['application/json'];
    if (!static::isContentTypeAllowed($request, $consumes)) {
   ...
   * @return Response the Symfony response
   */
  public function usersIdAppealPostAction(Request $request, $id): Response
  {
    // Make sure that the client is providing something that we can consume
    $consumes = ['application/json'];
    if (!static::isContentTypeAllowed($request, $consumes)) {
    ...
    try {
      ...
      $handler->usersIdAppealPost($id, $content_appeal_request, $responseCode, $responseHeaders);
   ...
   * @return Response the Symfony response
   */
  public function usersIdReportPostAction(Request $request, $id): Response
  {
    // Make sure that the client is providing something that we can consume
    $consumes = ['application/json'];
    if (!static::isContentTypeAllowed($request, $consumes)) {
   ...
   * @return Response the Symfony response
   */
  public function usersMeReportsGetAction(Request $request): Response
  {
    // Figure out what data format to return to the client
    $produces = ['application/json'];
    // Figure out what the client accepts
    ...
    try {
      ...
      $result = $handler->usersMeReportsGet($limit, $cursor, $responseCode, $responseHeaders);
