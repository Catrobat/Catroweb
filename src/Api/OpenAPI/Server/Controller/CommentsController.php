...
class CommentsController extends Controller
{
  ...
  /**
   * Operation projectsIdCommentsGet.
   *
   ...
   * @return Response the Symfony response
   */
  public function projectsIdCommentsGetAction(Request $request, $id): Response
  {
    // Figure out what data format to return to the client
    $produces = ['application/json'];
    // Figure out what the client accepts
    ...
    try {
      ...
      $result = $handler->projectsIdCommentsGet($id, $accept_language, $limit, $cursor, $responseCode, $responseHeaders);
  ...
  /**
   * Operation projectsIdCommentsPost.
   *
   ...
   * @return Response the Symfony response
   */
  public function projectsIdCommentsPostAction(Request $request, $id): Response
  {
    ...
    try {
      ...
      $result = $handler->projectsIdCommentsPost($id, $comment_create_request, $accept_language, $responseCode, $responseHeaders);
