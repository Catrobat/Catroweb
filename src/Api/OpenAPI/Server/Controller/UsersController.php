...
class UsersController extends Controller
{
  ...
  public function usersGetAction(Request $request): Response
  {
    ...
    try {
      ...
      $result = $handler->usersGet($query, $limit, $cursor, $responseCode, $responseHeaders);
   ...
   * @return Response the Symfony response
   */
  public function usersIdGetAction(Request $request, $id): Response
  {
    // Figure out what data format to return to the client
    $produces = ['application/json'];
    // Figure out what the client accepts
    ...
    try {
      ...
      $result = $handler->usersIdGet($id, $responseCode, $responseHeaders);
   ...
   * @return Response the Symfony response
   */
  public function usersMeDataExportGetAction(Request $request): Response
  {
    // Figure out what data format to return to the client
    $produces = ['application/json'];
    // Figure out what the client accepts
    ...
    try {
      ...
      $result = $handler->usersMeDataExportGet($responseCode, $responseHeaders);
   ...
   * @return Response the Symfony response
   */
  public function usersMeDeleteAction(Request $request): Response
  {
    // Handle authentication
    // Authentication 'BearerAuth' required
    // HTTP bearer authentication required
    ...
    try {
      ...
      $handler->usersMeDelete($responseCode, $responseHeaders);
   ...
   * @return Response the Symfony response
   */
  public function usersMeGetAction(Request $request): Response
  {
    // Figure out what data format to return to the client
    $produces = ['application/json'];
    // Figure out what the client accepts
    ...
    try {
      ...
      $result = $handler->usersMeGet($responseCode, $responseHeaders);
   ...
   * @return Response the Symfony response
   */
  public function usersMePatchAction(Request $request): Response
  {
    ...
    try {
      ...
      $result = $handler->usersMePatch($update_user_request, $accept_language, $responseCode, $responseHeaders);
   ...
   * @return Response the Symfony response
   */
  public function usersPostAction(Request $request): Response
  {
    // Make sure that the client is providing something that we can consume
    $consumes = ['application/json'];
    if (!static::isContentTypeAllowed($request, $consumes)) {
    ...
    try {
      ...
      $result = $handler->usersPost($register_request, $accept_language, $responseCode, $responseHeaders);
   ...
   * @return Response the Symfony response
   */
  public function usersResetPasswordPostAction(Request $request): Response
  {
    // Make sure that the client is providing something that we can consume
    $consumes = ['application/json'];
    if (!static::isContentTypeAllowed($request, $consumes)) {
    ...
    try {
      ...
      $result = $handler->usersResetPasswordPost($reset_password_request, $accept_language, $responseCode, $responseHeaders);
  ...
  public function usersSearchGetAction(Request $request): Response
  {
    ...
    try {
      ...
      $result = $handler->usersSearchGet($query, $limit, $cursor, $attributes, $responseCode, $responseHeaders);
