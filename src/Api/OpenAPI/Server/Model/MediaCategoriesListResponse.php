...
/**
 * Class representing the MediaCategoriesListResponse model.
 *
 * @author  OpenAPI Generator team
 */
class MediaCategoriesListResponse
{
  /**
   * @var MediaCategoryResponse[]|null
   *
   * @SerializedName("data")
   *
   * @Assert\All({
   ...
   * Gets data.
   *
   * @return MediaCategoryResponse[]|null
   */
   ...
   * Sets data.
   *
   * @param MediaCategoryResponse[]|null $data
   *
   * @return $this
   */
