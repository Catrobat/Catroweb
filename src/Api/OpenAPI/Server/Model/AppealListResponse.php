...
/**
 * Class representing the AppealListResponse model.
 *
 * @author  OpenAPI Generator team
 */
...
{
  /**
   * @var AppealResponse[]|null
   *
   * @SerializedName("data")
   *
   * @Assert\All({
   *
   *   @Assert\Type("OpenAPI\Server\Model\AppealResponse")
   * })
   *
   * @Type("array<OpenAPI\Server\Model\AppealResponse>")
   */
   ...
   * Sets data.
   *
   * @param AppealResponse[]|null $data
   *
   * @return $this
   */
