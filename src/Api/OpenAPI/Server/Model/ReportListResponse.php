...
/**
 * Class representing the ReportListResponse model.
 *
 * @author  OpenAPI Generator team
 */
class ReportListResponse
{
   ...
   * @Assert\All({
   *
   *   @Assert\Type("OpenAPI\Server\Model\ReportResponse")
   * })
   *
   * @Type("array<OpenAPI\Server\Model\ReportResponse>")
   */
   ...
   * Sets data.
   *
   * @param ReportResponse[]|null $data
   *
   * @return $this
   */
