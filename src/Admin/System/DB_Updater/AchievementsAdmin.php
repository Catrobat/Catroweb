...
class AchievementsAdmin extends AbstractAdmin
{
  ...
  protected function configureListFields(ListMapper $list): void
  {
    $list
      ...
      ->add('badge_svg_path', null, ['template' => 'Admin/SystemManagement/DbUpdater/Achievements/AchievementBadgeImage.html.twig'])
      ->add('badge_locked_svg_path', null, ['template' => 'Admin/SystemManagement/DbUpdater/Achievements/AchievementBadgeLockedImage.html.twig'])
      ->add('banner_color')
      ->add('enabled')
