...
class OnlyDefinedImagesValidatorSpec extends ObjectBehavior
{
    ...
    {
      $file->getPath()->willReturn(__SPEC_FIXTURE_DIR__."/base");
      $file->getProjectXmlProperties()->willReturn(simplexml_load_file(__SPEC_FIXTURE_DIR__."/base/code.xml"));
    ...
    {
      $file->getPath()->willReturn(__SPEC_FIXTURE_DIR__."/project_with_extra_image");
      
      $file->getProjectXmlProperties()->willReturn(simplexml_load_file(__SPEC_FIXTURE_DIR__."/project_with_extra_image/code.xml"));
