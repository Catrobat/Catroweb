...
class ExtractedFileValidatorSpec extends ObjectBehavior
{
  ...
  {
    $this->shouldHaveType('Catrobat\CatrowebBundle\Services\Validators\ExtractedFileValidator');
  }
    
  /**
  * @param \Catrobat\CatrowebBundle\Services\Validators\ExtractedCatrobatFileValidatorInterface $validator1
  * @param \Catrobat\CatrowebBundle\Services\Validators\ExtractedCatrobatFileValidatorInterface $validator2
  * @param \Catrobat\CatrowebBundle\Services\Validators\ExtractedCatrobatFileValidatorInterface $validator3
  * @param \Catrobat\CatrowebBundle\Model\ExtractedCatrobatFile $extracted_file
	*/
  ...
  function it_passes_through_an_exception_thrown_by_a_validator($validator1, $extracted_file)
  {
    ...
    $this->addValidator($validator1);
    $this->shouldThrow('Catrobat\CatrowebBundle\Exceptions\InvalidCatrobatFileException')->duringValidate($extracted_file);
  }
