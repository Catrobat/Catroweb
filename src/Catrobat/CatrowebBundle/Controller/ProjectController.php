...
class ProjectController
{
  ...
  public function indexAction()
  {
    ...
    return $this->templating->renderResponse('CatrowebBundle:Default:index.html.twig');
  }
  ...
  public function mostDownloadedAction(Request $request)
  {
    ...
    return $this->templating->renderResponse('CatrowebBundle:Project:mostDownloaded.html.twig', array("entities" => $entities));
  }
  ...
  public function newestAction(Request $request)
  {
    ...
    return $this->templating->renderResponse('CatrowebBundle:Project:newest.html.twig', array("entities" => $entities));
  }
  ...
  public function mostViewedAction(Request $request, $limit = 3)
  {
    ...
    return $this->templating->renderResponse('CatrowebBundle:Project:mostViewed.html.twig', array("entities" => $entities));
  }
  ...
  public function showAction($id)
  {
    ...
    return $this->templating->renderResponse('CatrowebBundle:Project:show.html.twig', array("entity" => $entity));
  }
