...
class RequiredFieldsValidator implements ExtractedCatrobatFileValidatorInterface
{

	/* (non-PHPdoc)
	 * @see \Catrobat\CatrowebBundle\Services\Validators\ExtractedCatrobatFileValidatorInterface::validate()
	 */
