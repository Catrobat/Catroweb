...
class UserLDAPManager extends LdapManager
{
  ...
  public function __construct(LdapDriverInterface $driver,UserManager $userManager, array $params, $role_mappings,
                              $group_filter, $tokengenerator,Logger $logger)
  {
  ...
  public function findUserBy(array $criteria)
  {
    try{
      ...
      $sameEmailUser = $usermanager->findOneBy(array("email"=>$entries[0]['mail']));
  ...
  public function bind(UserInterface $user, $password)
  {
    ...
    $entries = $this->driver->search($this->params['baseDn'], $filter, array("cn"));
