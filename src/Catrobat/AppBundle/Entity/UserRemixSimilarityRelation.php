...
class UserRemixSimilarityRelation
{
  ...
  /**
   * @ORM\ManyToOne(targetEntity="\Catrobat\AppBundle\Entity\User", inversedBy="relations_of_similar_users_based_on_remixes",
   *                                                                fetch="LAZY")
  ...
  /**
   * @ORM\ManyToOne(targetEntity="\Catrobat\AppBundle\Entity\User", inversedBy="reverse_relations_of_similar_users_based_on_remixes",
   *                                                                fetch="LAZY")
