...
class ProgramRemixBackwardRelation implements ProgramRemixRelationInterface, ProgramCatrobatRemixRelationInterface
{
  ...
  /**
   * @ORM\ManyToOne(targetEntity="\Catrobat\AppBundle\Entity\Program", inversedBy="catrobat_remix_backward_child_relations",
   *                                                                   fetch="LAZY")
  ...
  /**
   * @ORM\ManyToOne(targetEntity="\Catrobat\AppBundle\Entity\Program", inversedBy="catrobat_remix_backward_parent_relations",
   *                                                                   fetch="LAZY")
