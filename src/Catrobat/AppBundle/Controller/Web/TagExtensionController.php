...
class TagExtensionController extends Controller
{
  ...
  {
    return $this->get('templating')->renderResponse('tagSearch.html.twig', ['q' => $q]);
  }
  ...
  {
    return $this->get('templating')->renderResponse('search.html.twig', ['q' => null]);
  }
  ...
  {
    return $this->get('templating')->renderResponse('extensionSearch.html.twig', ['q' => $q]);
  }
