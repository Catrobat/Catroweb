...
class RemixSubgraphManipulator
{
                                                         ...
                                                         array $preserved_creation_date_mapping, array $preserved_seen_date_mapping)
    {
        ...
        $parent_ancestor_ids = array_unique(array_map(function($r) { return $r->getAncestorId(); }, $parents_ancestor_relations));
        ...
        $unique_keys_of_all_existing_relations = array_map(function($r) { return $r->getUniqueKey(); }, $all_existing_relations);
        ...
        foreach ($program_descendant_relations as $descendant_relation) {
            foreach ($parents_ancestor_relations as $parent_catrobat_relation) {
                ...
                } else if (array_key_exists(self::COMMON_TIMESTAMP, $preserved_creation_date_mapping)) {
                ...
                } else if (array_key_exists(self::COMMON_TIMESTAMP, $preserved_seen_date_mapping)) {
