...
class RemixManipulationCatrobatFileExtractor extends CatrobatFileExtractor
{
    ...
    public function generateRemixUrlsStringForMergedProgram($previous_parent_string, $current_parent_url)
    {
        ...
        return 'PREVIOUS: '
             . RemixUrlIndicator::PREFIX_INDICATOR . $previous_parent_string . RemixUrlIndicator::SUFIX_INDICATOR . ', '
             . 'NEXT: '
             . RemixUrlIndicator::PREFIX_INDICATOR . $current_parent_url . RemixUrlIndicator::SUFIX_INDICATOR;
    }
}
