...
class ExtractedCatrobatFile
{
    ...
    {
        $remixes_string = trim($migration_mode ? $this->getRemixMigrationUrlsString() : $this->getRemixUrlsString());
        ...
        for ($index = 0; $index < strlen($remixes_string); $index++) {
            ...
            } else if ($current_character == RemixUrlIndicator::SUFIX_INDICATOR) {
