...
use Catrobat\AppBundle\Entity\UserRemixSimilarityRelationRepository;
...
class RecommenderManager
{
    ...
    public function computeUserLikeSimilarities($progress_bar = null)
    {
        ...
        foreach ($rated_users as $first_user) {
            ...
            $ids_of_programs_liked_by_first_user = array_map(function ($like) { return $like->getProgramId(); }, $first_user_likes);
            ...
            foreach ($rated_users as $second_user) {
                ...
                $ids_of_programs_liked_by_second_user = array_map(function ($like) { return $like->getProgramId(); }, $second_user_likes);
    ...
    public function computeUserRemixSimilarities($progress_bar = null)
    {
        ...
        foreach ($user_remix_relations as $first_user_id => $first_user_remix_relations) {
            $ids_of_programs_remixed_by_first_user = array_unique(array_map(function ($data) { return $data['ancestor_id']; }, $first_user_remix_relations));
            ++$user_counter;
            ...
            foreach ($user_remix_relations as $second_user_id => $second_user_remix_relations) {
                ...
                $already_added_relations[] = $key;
                $ids_of_programs_remixed_by_second_user = array_unique(array_map(function ($data) { return $data['ancestor_id']; }, $second_user_remix_relations));
