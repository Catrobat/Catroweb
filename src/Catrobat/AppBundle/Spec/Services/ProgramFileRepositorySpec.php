...
class ProgramFileRepositorySpec extends ObjectBehavior
{
  ...
  function let()
  {
    ...
    $this->beConstructedWith($this->storage_dir,"", new CatrobatFileCompressor());
  }
  ...
  {
    $this->shouldThrow('Catrobat\AppBundle\Exceptions\InvalidStorageDirectoryException')->during('__construct', array(__DIR__ . "/invalid_directory/", "", new CatrobatFileCompressor()));
  }
