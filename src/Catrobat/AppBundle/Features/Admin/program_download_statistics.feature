...
Scenario: As a valid admin i want to be able to see the statistics
  ...
  And there are program download statistics:
    | id | program_id | downloaded_at        | ip             | latitude      |  longitude  | country_code  | country_name | street              | postal_code      |  locality   |
    | 1  | 1          |  2015-11-21 13:39:00 | 88.116.169.222 | 47.2          | 10.7        | AT            | Austria      | Duck Street 1       | 1234             | Entenhausen |
  When I GET "/admin/download_stats/list"
  Then the response should contain the elements:
    | id | downloaded_at            | ip             | latitude      |  longitude  | country_code  | country_name | street              | postal_code      |  locality   |
    | id | downloaded_at            | ip             | latitude      |  longitude  | country_code  | country_name | street              | postal_code      |  locality   |
    | 1  | November 21, 2015 13:39  | 88.116.169.222 | 47.2          | 10.7        | AT            | Austria      | Duck Street 1       | 1234             | Entenhausen |
