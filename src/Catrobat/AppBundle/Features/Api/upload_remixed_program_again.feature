...
Feature: Upload a remixed program with multiple parents
  ...
  Scenario: reuploading program 6 with additional backward parent creates backward relation and unlinks former parent
    ...
    #-------------------------------------------------------------------------------------------------------------------
    Given I am "Catrobat"
    Given I have a program with "name" set to "program 6", "url" set to "program 6[/pocketcode/program/6], Merge 1[program 5[/pocketalice/program/5], program 7[/pocketalice/program/7]]" and "catrobatLanguageVersion" set to "0.993"
    When I upload a program
    Then the uploaded program should not be a remix root
    And the uploaded program should have remix migration date NOT NULL
    And the uploaded program should have a Catrobat forward ancestor having id "6" and depth "0"
    ...
    And the uploaded program should have a Catrobat forward descendant having id "7" and depth "1"
    And the uploaded program should have no further Catrobat forward descendants
    And the uploaded program should have RemixOf "program 6[/pocketcode/program/6], Merge 1[program 5[/pocketalice/program/5], program 7[/pocketalice/program/7]]" in the xml
  ...
  Scenario: reuploading former root program 1 with two new Scratch parents and one additional backward parent
    ...
    #-------------------------------------------------------------------------------------------------------------------
    Given I am "Catrobat"
    Given I have a program with "name" set to "program 1", "url" set to "Test Scratch [https://scratch.mit.edu/projects/1], Merge1[program 6[/pocketcode/program/6], Music Inventor [https://scratch.mit.edu/projects/29495624]]" and "catrobatLanguageVersion" set to "0.993"
    When I upload a program
    ...
    And the uploaded program should have no further Catrobat forward descendants
    And the uploaded program should have RemixOf "Test Scratch [https://scratch.mit.edu/projects/1], Merge1[program 6[/pocketcode/program/6], Music Inventor [https://scratch.mit.edu/projects/29495624]]" in the xml
  ...
  Scenario: reuploading former root program 1 with one new Scratch parent and one additional backward parent
    ...
    #-------------------------------------------------------------------------------------------------------------------
    Given I am "Catrobat"
    Given I have a program with "name" set to "program 1", "url" set to "program 7[/pocketcode/program/7], Music Inventor [https://scratch.mit.edu/projects/29495624]" and "catrobatLanguageVersion" set to "0.993"
    When I upload a program
    Then the uploaded program should be a remix root
    And the uploaded program should have remix migration date NOT NULL
    And the uploaded program should have a Catrobat forward ancestor having id "1" and depth "0"
    ...
    And the uploaded program should have a Catrobat forward descendant having id "7" and depth "3"
    And the uploaded program should have no further Catrobat forward descendants
    And the uploaded program should have RemixOf "program 7[/pocketcode/program/7], Music Inventor [https://scratch.mit.edu/projects/29495624]" in the xml
