...
final class Version20200407102527 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE example (id INT AUTO_INCREMENT NOT NULL, program_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:guid)\', imagetype VARCHAR(255) NOT NULL, url VARCHAR(255) DEFAULT NULL, active TINYINT(1) NOT NULL, flavor VARCHAR(255) DEFAULT \'pocketcode\' NOT NULL, priority INT NOT NULL, for_ios TINYINT(1) DEFAULT \'0\' NOT NULL, INDEX IDX_6EEC9B9F3EB8070A (program_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
