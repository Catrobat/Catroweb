...
final class Version20190313173221 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE nolb_example_program (id INT AUTO_INCREMENT NOT NULL, program_id INT DEFAULT NULL, active TINYINT(1) NOT NULL, is_for_female TINYINT(1) NOT NULL, downloads_from_male INT NOT NULL, downloads_from_female INT NOT NULL, UNIQUE INDEX UNIQ_66FFF6983EB8070A (program_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB COMMENT = \'\' ');
