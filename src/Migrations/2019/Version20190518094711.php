 ...
 */
final class Version20190518094711 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE GameJam (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(300) NOT NULL COLLATE utf8mb4_unicode_ci, form_url VARCHAR(300) DEFAULT NULL COLLATE utf8mb4_unicode_ci, start DATETIME NOT NULL, end DATETIME NOT NULL, hashtag VARCHAR(100) DEFAULT NULL COLLATE utf8mb4_unicode_ci, flavor VARCHAR(100) DEFAULT NULL COLLATE utf8mb4_unicode_ci, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('CREATE TABLE gamejams_sampleprograms (gamejam_id INT NOT NULL, program_id INT NOT NULL, INDEX IDX_8EADA1363EB8070A (program_id), INDEX IDX_8EADA13654B8758D (gamejam_id), PRIMARY KEY(gamejam_id, program_id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB COMMENT = \'\' ');
