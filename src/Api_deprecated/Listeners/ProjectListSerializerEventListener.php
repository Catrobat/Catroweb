 ...
 * @deprecated
 */
#[AsEventListener(event: KernelEvents::VIEW, method: 'serializeProjectResponse')]
readonly class ProjectListSerializerEventListener
{
   ...
   * @throws \Exception
   */
  public function serializeProjectResponse(ViewEvent $event): void
  {
