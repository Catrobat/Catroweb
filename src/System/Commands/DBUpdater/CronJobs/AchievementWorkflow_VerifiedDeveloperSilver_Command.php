...
#[AsCommand(name: 'catrobat:workflow:achievement:verified_developer_silver', description: 'Unlocking verified_developer user achievements')]
class AchievementWorkflow_VerifiedDeveloperSilver_Command extends Command
{
  ...
  protected function addVerifiedDeveloperAchievementToEveryUser(OutputInterface $output): void
  {
    ...
    foreach ($user_list as $user) {
      try {
        ...
        $user_achievement->setUnlockedAt($user->getCreatedAt() ?? TimeUtils::getDateTime());
