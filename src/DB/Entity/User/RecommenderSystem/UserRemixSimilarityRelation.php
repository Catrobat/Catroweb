...
class UserRemixSimilarityRelation
{
  ...
  #[ORM\ManyToOne(targetEntity: User::class, inversedBy: 'relations_of_similar_users_based_on_remixes', fetch: 'LAZY')]
  ...
  #[ORM\ManyToOne(targetEntity: User::class, inversedBy: 'reverse_relations_of_similar_users_based_on_remixes', fetch: 'LAZY')]
