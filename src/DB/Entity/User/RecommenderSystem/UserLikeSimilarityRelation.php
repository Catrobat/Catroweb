...
class UserLikeSimilarityRelation
{
  ...
  #[ORM\ManyToOne(targetEntity: User::class, inversedBy: 'relations_of_similar_users_based_on_likes', fetch: 'LAZY')]
  ...
  #[ORM\ManyToOne(targetEntity: User::class, inversedBy: 'reverse_relations_of_similar_users_based_on_likes', fetch: 'LAZY')]
