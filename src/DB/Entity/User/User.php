...
class User extends BaseUser
{
   ...
   */
  #[ORM\OneToMany(targetEntity: Program::class, mappedBy: 'user', fetch: 'EXTRA_LAZY', cascade: ['remove'])]
   ...
   */
  #[ORM\OneToMany(targetEntity: ResetPasswordRequest::class, mappedBy: 'user', fetch: 'EXTRA_LAZY', cascade: ['remove'])]
   ...
   */
  #[ORM\OneToMany(targetEntity: CatroNotification::class, mappedBy: 'user', fetch: 'EXTRA_LAZY', cascade: ['remove'])]
   ...
   */
  #[ORM\OneToMany(targetEntity: UserComment::class, mappedBy: 'user', fetch: 'EXTRA_LAZY', cascade: ['remove'])]
   ...
   */
  #[ORM\OneToMany(targetEntity: FollowNotification::class, mappedBy: 'follower', fetch: 'EXTRA_LAZY', cascade: ['remove'])]
   ...
   */
  #[ORM\OneToMany(targetEntity: LikeNotification::class, mappedBy: 'like_from', fetch: 'EXTRA_LAZY', cascade: ['remove'])]
