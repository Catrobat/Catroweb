...
class ProgramRemixRelation implements ProgramRemixRelationInterface, ProgramCatrobatRemixRelationInterface, \Stringable
{
  ...
  #[ORM\ManyToOne(targetEntity: Program::class, inversedBy: 'catrobat_remix_descendant_relations', fetch: 'LAZY')]
  ...
  #[ORM\ManyToOne(targetEntity: Program::class, inversedBy: 'catrobat_remix_ancestor_relations', fetch: 'LAZY')]
