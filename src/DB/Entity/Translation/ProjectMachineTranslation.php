...
#[ORM\Entity(repositoryClass: \App\DB\EntityRepository\Translation\ProjectMachineTranslationRepository::class)]
...
class ProjectMachineTranslation extends MachineTranslation
{
  ...
  public function __construct(#[ORM\ManyToOne(targetEntity: Program::class)]
