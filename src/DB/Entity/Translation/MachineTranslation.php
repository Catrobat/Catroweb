...
abstract class MachineTranslation
{
  ...
  public function __construct(#[ORM\Column(type: 'string', length: 5)]
    protected string $source_language, #[ORM\Column(type: 'string', length: 5)]
    protected string $target_language, #[ORM\Column(type: 'string')]
    protected string $provider, #[ORM\Column(type: 'integer')]
