...
class ProgramRepository extends ServiceEntityRepository
{
  ...
  public function __construct(ManagerRegistry $managerRegistry, protected RequestHelper $app_request, FeatureFlagManager $feature_flag_manager)
  {
  ...
  private function setOrderByElastica(string $order_by = '', string $order = 'DESC'): array
  {
    if ('' !== trim($order_by)) {
