...
document.addEventListener('DOMContentLoaded', function () {
  const stealProjectButton = document.getElementById('stealProjectButton')
  if (stealProjectButton) {
    stealProjectButton.addEventListener('click', function () {
      const url = stealProjectButton.getAttribute('data-url')
      const programId = stealProjectButton.getAttribute('data-program-id')
