...
class Version20150714120632 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE featured (id INT AUTO_INCREMENT NOT NULL, program_id INT DEFAULT NULL, imagetype VARCHAR(255) NOT NULL, url VARCHAR(255) DEFAULT NULL, active TINYINT(1) NOT NULL, flavor VARCHAR(255) DEFAULT \'pocketcode\' NOT NULL, INDEX IDX_3C1359D43EB8070A (program_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE ProgramInappropriateReport (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, program_id INT DEFAULT NULL, note LONGTEXT NOT NULL, time DATETIME NOT NULL, state INT NOT NULL, projectVersion INT NOT NULL, INDEX IDX_ED222248A76ED395 (user_id), INDEX IDX_ED2222483EB8070A (program_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
