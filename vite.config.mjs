  ...
  return {
    ...
    css: {
      ...
      preprocessorOptions: {
        scss: {
          api: 'modern-compiler',
          // All four originate in node_modules/bootstrap/scss/* — Bootstrap 5
          // still uses these deprecated Sass features. Resolved in Bootstrap 6;
          // drop each entry below as we land that upgrade.
          //   - import:          @import (use @use/@forward)
          //   - global-builtin:  mix(), shade-color() etc. (use color.mix())
          //   - color-functions: darken(), lighten() (use color.adjust())
          //   - if-function:     if(a, b, c) (use modern @if/CSS if())
