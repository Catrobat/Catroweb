...
class CatrobatCodeParserTest extends \PHPUnit_Framework_TestCase
{
    protected $parser;
    ...
    {
        $programs = array();
        $programs[] = array(new ExtractedCatrobatFile(__DIR__ . '/Resources/ValidPrograms/SimpleProgram/', '', ''));
        $programs[] = array(new ExtractedCatrobatFile(__DIR__ . '/Resources/ValidPrograms/SceneProgram/', '', ''));
        $programs[] = array(new ExtractedCatrobatFile(__DIR__ . '/Resources/ValidPrograms/AllBricksProgram/', '', ''));
        return $programs;
    }
    ...
    {
        $programs = array();
        $programs[] = array(new ExtractedCatrobatFile(
