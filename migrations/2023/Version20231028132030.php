 ...
 */
final class Version20231028132030 extends AbstractMigration
{
  ...
  public function up(Schema $schema): void
  {
    ...
    $this->addSql('ALTER TABLE maintanance_information ADD ltm_maintenanceStart DATE DEFAULT NULL, ADD ltm_maintenanceEnd DATE DEFAULT NULL, ADD ltm_additionalInformation VARCHAR(255) DEFAULT NULL, DROP ltmParameters');
  ...
  public function down(Schema $schema): void
  {
    ...
    $this->addSql('ALTER TABLE maintanance_information ADD ltmParameters LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:json)\', DROP ltm_maintenanceStart, DROP ltm_maintenanceEnd, DROP ltm_additionalInformation');
