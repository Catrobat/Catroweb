 ...
 */
final class Version20231126222015 extends AbstractMigration
{
  ...
  public function up(Schema $schema): void
  {
    ...
    $this->addSql('ALTER TABLE maintanance_information DROP active, DROP closed');
  ...
  public function down(Schema $schema): void
  {
    ...
    $this->addSql('ALTER TABLE maintanance_information ADD active TINYINT(1) NOT NULL, ADD closed TINYINT(1) NOT NULL');
