...
final class Version20200214075253 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE CatroNotification ADD remix_from CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:guid)\', ADD remix_program_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:guid)\'');
        ...
        $this->addSql('CREATE INDEX IDX_22087FCA63B7B817 ON CatroNotification (remix_program_id)');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE CatroNotification DROP remix_from, DROP remix_program_id');
    }
}
