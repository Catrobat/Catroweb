 ...
 */
final class Version20210718185442 extends AbstractMigration
{
  ...
  public function up(Schema $schema): void
  {
    ...
    $this->addSql('CREATE TABLE studio_program (id INT AUTO_INCREMENT NOT NULL, studio CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', activity INT NOT NULL, program CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', user CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', updated_on DATETIME DEFAULT NULL, created_on DATETIME NOT NULL, INDEX IDX_4CB3C24A4A2B07B6 (studio), UNIQUE INDEX UNIQ_4CB3C24AAC74095A (activity), INDEX IDX_4CB3C24A92ED7784 (program), INDEX IDX_4CB3C24A8D93D649 (user), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    ...
    $this->addSql('ALTER TABLE user_comment ADD studio CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', ADD activity INT DEFAULT NULL, ADD parent_id INT DEFAULT NULL');
