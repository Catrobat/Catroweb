...
final class Version20211117171810 extends AbstractMigration
{
  ...
  public function up(Schema $schema): void
  {
    ...
    $this->addSql('ALTER TABLE program_downloads ADD user CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:guid)\', DROP user_id, DROP rec_from_program_id, DROP recommended_by_program_id, DROP ip, DROP country_code, DROP country_name, DROP user_agent, DROP referrer, DROP recommended_by_page_id, DROP locale, DROP user_specific_recommendation');
    ...
    $this->addSql('CREATE INDEX IDX_1D41556A8D93D649 ON program_downloads (user)');
