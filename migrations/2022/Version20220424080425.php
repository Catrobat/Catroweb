...
final class Version20220424080425 extends AbstractMigration
{
  ...
  public function up(Schema $schema): void
  {
    ...
    $this->addSql('ALTER TABLE ProgramInappropriateReport CHANGE category category TEXT NOT NULL');
  ...
  public function down(Schema $schema): void
  {
    ...
    $this->addSql('ALTER TABLE ProgramInappropriateReport CHANGE category category LONGTEXT NOT NULL');
