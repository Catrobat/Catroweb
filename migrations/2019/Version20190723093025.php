...
final class Version20190723093025 extends AbstractMigration
{
  ...
  public function up(Schema $schema): void
  {
    ...
    $this->addSql('ALTER TABLE gamejams_sampleprograms DROP FOREIGN KEY IF EXISTS FK_8EADA1363EB8070A');
    ...
    $this->addSql('ALTER TABLE program_downloads DROP FOREIGN KEY IF EXISTS FK_1D41556A1748903F');
    $this->addSql('ALTER TABLE program_downloads DROP FOREIGN KEY IF EXISTS FK_1D41556A3EB8070A');
    $this->addSql('ALTER TABLE program_downloads DROP FOREIGN KEY IF EXISTS FK_1D41556A7140A621');
    ...
    $this->addSql('ALTER TABLE program_downloads DROP FOREIGN KEY IF EXISTS FK_1D41556AA76ED395');
