...
class Version20170222111928 extends AbstractMigration
{
  ...
  public function up(Schema $schema): void
  {
    ...
    $this->addSql('ALTER TABLE project_downloads CHANGE locale locale VARCHAR(255) DEFAULT NULL');
  ...
  public function down(Schema $schema): void
  {
    ...
    $this->addSql('ALTER TABLE project_downloads CHANGE locale locale VARCHAR(255) DEFAULT \'\' COLLATE utf8_unicode_ci');
  }
}
