...
use App\Commands\DBUpdater\CronJobs\AchievementWorkflow_BronzeUser_Command;
 ...
 *
 * @internal
 * @covers \App\Commands\DBUpdater\CronJobs\AchievementWorkflow_BronzeUser_Command
 */
class AchievementWorkflow_BronzeUser_CommandTest extends KernelTestCase
{
  /**
   * @var AchievementWorkflow_BronzeUser_Command|MockObject
   */
  protected $object;
