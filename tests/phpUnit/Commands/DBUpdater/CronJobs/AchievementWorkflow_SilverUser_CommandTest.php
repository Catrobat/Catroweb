...
use App\Commands\DBUpdater\CronJobs\AchievementWorkflow_SilverUser_Command;
 ...
 *
 * @internal
 * @covers \App\Commands\DBUpdater\CronJobs\AchievementWorkflow_SilverUser_Command
 */
class AchievementWorkflow_SilverUser_CommandTest extends KernelTestCase
{
  /**
   * @var AchievementWorkflow_SilverUser_Command|MockObject
   */
  protected $object;
