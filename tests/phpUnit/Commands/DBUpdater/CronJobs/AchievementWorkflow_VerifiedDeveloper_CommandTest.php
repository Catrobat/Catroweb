...
use App\Commands\DBUpdater\CronJobs\AchievementWorkflow_VerifiedDeveloper_Command;
 ...
 *
 * @internal
 * @covers \App\Commands\DBUpdater\CronJobs\AchievementWorkflow_VerifiedDeveloper_Command
 */
class AchievementWorkflow_VerifiedDeveloper_CommandTest extends KernelTestCase
{
  /**
   * @var AchievementWorkflow_VerifiedDeveloper_Command|MockObject
   */
  protected $object;
