...
use App\Commands\DBUpdater\CronJobs\AchievementWorkflow_DiamondUser_Command;
 ...
 *
 * @internal
 * @covers \App\Commands\DBUpdater\CronJobs\AchievementWorkflow_DiamondUser_Command
 */
class AchievementWorkflow_DiamondUser_CommandTest extends KernelTestCase
{
  /**
   * @var AchievementWorkflow_DiamondUser_Command|MockObject
   */
  protected $object;
