...
class MediaFileAllGetTest extends WebTestCase
{
  ...
  public function testMedia(): void
  {
    ...
    $this->assertResponseStatusCodeSame(200);
    $data = $client->getResponse()->getContent();
    $this->assertJsonStringEqualsJsonString($data, '[{"id":4,"name":"Rabbit","flavors":["luna"],"packages":["Looks"],"category":"Looks Family","author":"CatrobatLuna","extension":"","download_url":"http:\/\/localhost\/app\/download-media\/4"},{"id":5,"name":"Bear","flavors":["pocketcode"],"packages":["Looks"],"category":"Looks Family","author":"Catrobat","extension":"","download_url":"http:\/\/localhost\/app\/download-media\/5"},{"id":6,"name":"Snake","flavors":["luna"],"packages":["Sounds"],"category":"Sounds Family","author":"CatrobatLuna","extension":"","download_url":"http:\/\/localhost\/app\/download-media\/6"}, {"id":7,"name":"Panda 2","flavors":["pocketcode"],"packages":["Looks"],"category":"Looks Family","author":"Catrobat","extension":"","download_url":"http:\/\/localhost\/app\/download-media\/7"}]');

    $client->request('GET', '/api/media/files', ['offset' => 2, 'limit' => 2], [], ['HTTP_ACCEPT' => 'application/json']);
    $this->assertResponseStatusCodeSame(200);
    $data = $client->getResponse()->getContent();
    $this->assertJsonStringEqualsJsonString($data, '[{"id":3,"name":"Dog","flavors":["pocketcode"],"packages":["Looks"],"category":"Looks Family","author":"Catrobat","extension":"","download_url":"http:\/\/localhost\/app\/download-media\/3"},{"id":4,"name":"Rabbit","flavors":["luna"],"packages":["Looks"],"category":"Looks Family","author":"CatrobatLuna","extension":"","download_url":"http:\/\/localhost\/app\/download-media\/4"}]');
  }
