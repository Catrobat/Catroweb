@admin
Feature: Adminius click statistics feature
  ...
  Background:
    ...
    And there are projects:
      ...
      | 1  | Minions | p1          | Catrobat  | 3         | 2             | 12    | 01.01.2013 12:01 | 0.8.5   | mindstorms,phiro | Game,Animation,Story,Music | true       |
      | 2  | Galaxy  | p2          | OtherUser | 10        | 12            | 13    | 01.02.2013 12:00 | 0.8.5   | mindstorms,drone | Game,Animation,Story       | false      |
      | 3  | Alone   | p3          | Catrobat  | 5         | 55            | 2     | 01.03.2013 12:00 | 0.8.5   |                  | Game,Animation             | true       |
      | 4  | Trolol  | p5          | Catrobat  | 5         | 1             | 1     | 01.03.2013 12:00 | 0.8.5   | mindstorms       | Art                        | true       |
      | 5  | Nothing | p6          | Catrobat  | 5         | 1             | 1     | 01.03.2013 12:00 | 0.8.5   |                  | Experimental               | true       |


    And there are click statistics:
      | type                  | user_agent                      | user      | referrer                                      | locale | rec_program_id | rec_from_id | tag_name     | extension_name | clicked_at            |
      ...
      | tags                  | Mozilla/5.0 (X11; Linux x86_64) | Catrobat  | http://localhost/index_test.php/app/project/1 | en_us  |                |             | Animation    |                | August 15, 2020 20:22 |
      | tags                  | Chrome/5.0 (X11; Linux x86_64)  | OtherUser | http://localhost/index_test.php/app/project/3 | en_us  |                |             | Game         |                | August 15, 2020 20:23 |
      | tags                  | Chrome/5.0 (X11; Linux x86_64)  | OtherUser | http://localhost/index_test.php/app/project/5 | en_us  |                |             | Experimental |                | August 15, 2020 20:24 |
      ...
      | extensions            | Mozilla/5.0 (X11; Linux x86_64) | Catrobat  | http://localhost/index_test.php/app/project/4 | en_us  |                |             |              | mindstorms     | August 15, 2020 20:30 |
  ...
  Scenario: As admin I should be able to see list of all click statistics
    ...
    Then I should see the table with all click statistics in the following order:
      ...
      | 11 | extensions            | Catrobat  |              |                    |                          |              | mindstorms | August 15, 2020 20:30 | en_us  | Mozilla/5.0 (X11; Linux x86_64) | http://localhost/index_test.php/app/project/4 |
