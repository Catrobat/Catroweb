...
Feature: Follow feature on profiles
  ...
  Scenario: Follow user should follow and increase counter
    ...
    And the element "#follow-btn" should have a attribute "title" with value "Unfollow this user!"
  ...
  Scenario: Unfollow user should unfollow and decrease counter
    ...
    And the element "#follow-btn" should have a attribute "title" with value "Follow this user!"
