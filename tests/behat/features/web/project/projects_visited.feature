@homepage
Feature: Pocketcode homepage visited projects
  Visited projects should be marked.
  ...
  Scenario: Clicking on a project and then going back to homepage. Now the project should be marked on the homepage.
