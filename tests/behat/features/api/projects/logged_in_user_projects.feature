...
Feature: Logged in user projects
  ...
  Background:
    ...
    And there are programs:
      ...
      | 25 | project 25|  Catrobat | 40    | 01.08.2015 12:00 | 1048576  | 0.8.5   | 0.985            |  pocketcode |
      | 26 | project 26|  Catrobat | 40    | 01.08.2016 12:00 | 1048576  | 0.8.5   | 0.985            |  luna       |
    ...
    Then I should get the json object:
      ...
      [
        ...
        },
        {
          ...
          "screenshot_large": "http://localhost/images/default/screenshot.png",
          "screenshot_small": "http://localhost/images/default/thumbnail.png",
          "project_url": "http://localhost/app/project/25",
          "download_url": "http://localhost/app/download/25.catrobat",
          "filesize": 0
        }
      ]
      """
