...
Feature: Upload a remixed program with multiple parents
  ...
  Catrobat language version 0.993 should correctly add remix relations
    ...
    #               (7)
    #-------------------------------------------------------------------------------------------------------------------
    Given I have a program with "catrobatLanguageVersion" set to "0.993" and "url" set to "Program 1 [/pocketcode/program/1], Program 8 [https://share.catrob.at/pocketcode/program/8]"
    When I upload a program
  ...
  Catrobat language version 1 should correctly add remix relations (example #1)
    ...
    #
    #-------------------------------------------------------------------------------------------------------------------
    Given I have a program with "catrobatLanguageVersion" set to "1" and "url" set to "Program 2 [/pocketalice/program/2], Merge 1 [Program 7 [/pocketcode/program/7], Program 9 [https://share.catrob.at/pocketcode/program/9]]"
    When I upload a program
    Then the uploaded program should not be a remix root
    And the uploaded program should have remix migration date NOT NULL
    And the uploaded program should have a Catrobat forward ancestor having id "10" and depth "0"
    ...
    And the uploaded program should have a Catrobat forward ancestor having id "2" and depth "3"
    And the uploaded program should have a Catrobat forward ancestor having id "2" and depth "4"
    And the uploaded program should have a Catrobat forward ancestor having id "3" and depth "3"
  ...
  Catrobat language version 1.0 should correctly add remix relations (example #2)
    ...
    #-------------------------------------------------------------------------------------------------------------------
    Given I have a program with "catrobatLanguageVersion" set to "1.0" and "url" set to "The Colour Divide - Trailer [https://scratch.mit.edu/projects/70058680/], Merge 2 [Program 2 [/pocketalice/program/2], Merge 1 [Program 6 [/pocketcode/program/6], Program 8 [https://share.catrob.at/pocketcode/program/8]]]"
    When I upload a program
    Then the uploaded program should not be a remix root
    And the uploaded program should have remix migration date NOT NULL
    And the uploaded program should have a Catrobat forward ancestor having id "10" and depth "0"
    ...
    And the uploaded program should have a Catrobat forward ancestor having id "6" and depth "1"
    And the uploaded program should have a Catrobat forward ancestor having id "8" and depth "1"
    And the uploaded program should have no further Catrobat forward ancestors
    And the uploaded program should have no Catrobat backward parents
    And the uploaded program should have a Scratch parent having id "70058680"
  ...
  Catrobat language version 1.1 should correctly add remix relations (example #2)
    ...
    #       This test will also check that no backward parents of parent program will be linked to the uploaded program.
    #-------------------------------------------------------------------------------------------------------------------
    Given I have a program with "catrobatLanguageVersion" set to "1.1" and "url" set to "The Colour Divide - Trailer [https://scratch.mit.edu/projects/70058680/], Merge 2 [Program 2 [/pocketalice/program/2], Merge 1 [Program 6 [/pocketcode/program/6], Program 8 [https://share.catrob.at/pocketcode/program/8]]]"
    When I upload a program
    Then the uploaded program should not be a remix root
    And the uploaded program should have remix migration date NOT NULL
    And the uploaded program should have a Catrobat forward ancestor having id "10" and depth "0"
