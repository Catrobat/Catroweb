...
Feature: Project reactions API
  ...
  # === POST /api/projects/{id}/reaction - Add reaction ===
  ...
  Scenario: Adding a reaction to a non-existent project returns 404
    ...
    """
    And I request "POST" "/api/projects/999/reaction"
  ...
  Scenario: Adding a reaction to a non-visible project returns 404 for non-owner
    ...
    """
    And I request "POST" "/api/projects/3/reaction"
    Then the response status code should be "404"
  ...
  Scenario: Adding a duplicate reaction returns 409 (already exists)
    ...
    """
    And I request "POST" "/api/projects/2/reaction"
    Then the response status code should be "409"

  # === DELETE /api/projects/{id}/reaction - Remove reaction ===

  Scenario: Remove a reaction from a project
    Given I use a valid JWT Bearer token for "Catrobat"
    And I have a request header "HTTP_ACCEPT" with value "application/json"
    And I request "DELETE" "/api/projects/2/reaction?type=thumbs_up"
  ...
  Scenario: Removing a reaction with invalid type returns 400
    Given I use a valid JWT Bearer token for "Catrobat"
    And I have a request header "HTTP_ACCEPT" with value "application/json"
    And I request "DELETE" "/api/projects/2/reaction?type=invalid_type"
    Then the response status code should be "400"

  Scenario: Removing a non-existent reaction returns 204 (idempotent)
    Given I use a valid JWT Bearer token for "Catrobat"
    And I have a request header "HTTP_ACCEPT" with value "application/json"
    And I request "DELETE" "/api/projects/1/reaction?type=thumbs_up"
    Then the response status code should be "204"

  Scenario: Removing a reaction from a non-existent project returns 404
    Given I use a valid JWT Bearer token for "Catrobat"
    And I have a request header "HTTP_ACCEPT" with value "application/json"
    And I request "DELETE" "/api/projects/999/reaction?type=thumbs_up"
    Then the response status code should be "404"

  # === GET /api/projects/{id}/reactions - Get reaction summary ===

  Scenario: Get reaction summary for a project
    Given I have a request header "HTTP_ACCEPT" with value "application/json"
    And I request "GET" "/api/projects/2/reactions"
  ...
  # === GET /api/projects/{id}/reactions/users - Get reaction users ===

  Scenario: Get users who reacted to a project
    Given I have a request header "HTTP_ACCEPT" with value "application/json"
    And I request "GET" "/api/projects/2/reactions/users"
    Then the response status code should be "200"
  ...
  Scenario: Get users with limit parameter
    Given I have a request header "HTTP_ACCEPT" with value "application/json"
    And I request "GET" "/api/projects/2/reactions/users?limit=1"
    Then the response status code should be "200"
    And the client response should contain "data"
  ...
  Scenario: Get users filtered by reaction type
    Given I have a request header "HTTP_ACCEPT" with value "application/json"
    And I request "GET" "/api/projects/2/reactions/users?type=love"
    Then the response status code should be "200"
  ...
  Scenario: Get reaction users for non-existent project returns 404
    Given I have a request header "HTTP_ACCEPT" with value "application/json"
    And I request "GET" "/api/projects/999/reactions/users"
    Then the response status code should be "404"

  Scenario: Get reaction users for non-visible project returns 404 for non-owner
    Given I have a request header "HTTP_ACCEPT" with value "application/json"
    And I request "GET" "/api/projects/3/reactions/users"
    Then the response status code should be "404"
