...
Feature: Upload a project with tag
  ...
  Scenario: uploading a embroidery project should add the embroidery extension to the project
  ...
  Scenario: uploading a normal project should must not add an extension to the project
