...
Feature: Upload a remixed program with multiple parents
  ...
  Catrobat language version 0.993 should correctly add remix relations
    ...
    And the uploaded project should have a Catrobat forward ancestor having id "8" and depth "1", API version 2
  ...
  Catrobat language version 1 should correctly add remix relations (example #1)
    ...
    And the uploaded project should have a Catrobat forward ancestor having id "1" and depth "4", API version 2
    And the uploaded project should have a Catrobat forward ancestor having id "1" and depth "5", API version 2
    And the uploaded project should have a Catrobat forward ancestor having id "2" and depth "1", API version 2
    And the uploaded project should have a Catrobat forward ancestor having id "2" and depth "3", API version 2
    And the uploaded project should have a Catrobat forward ancestor having id "2" and depth "4", API version 2
    And the uploaded project should have a Catrobat forward ancestor having id "3" and depth "3", API version 2
  ...
  Catrobat language version 1.0 should correctly add remix relations (example #2)
    ...
    And the uploaded project should have a Catrobat forward ancestor having id "2" and depth "3", API version 2
    And the uploaded project should have a Catrobat forward ancestor having id "3" and depth "2", API version 2
    And the uploaded project should have a Catrobat forward ancestor having id "4" and depth "2", API version 2
    And the uploaded project should have a Catrobat forward ancestor having id "6" and depth "1", API version 2
    And the uploaded project should have a Catrobat forward ancestor having id "8" and depth "1", API version 2
    And the uploaded project should have no further Catrobat forward ancestors, API version 2
    And the uploaded project should have no Catrobat backward parents, API version 2
    And the uploaded project should have a Scratch parent having id "70058680", API version 2
