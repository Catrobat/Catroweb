...
Feature: Upload a remixed project with multiple parents should also work with the new UUIDs
  ...
  Scenario: reuploading project 4 with only one parent unlinks former parent
    ...
    And the uploaded project should have RemixOf "project 390a46b7-4dca-11ea-b467-08002765cf2c[/pocketalice/project/390a46b7-4dca-11ea-b467-08002765cf2c]" in the xml, API version 2
