...
Feature: Followers API endpoints
  ...
  # ---------------------------------------------------------------------------
  # GET /api/user/{id}/followers — public endpoint
  # ---------------------------------------------------------------------------

  Scenario: Get followers without auth returns 200
    Given I have a request header "HTTP_ACCEPT" with value "application/json"
    And I request "GET" "/api/user/1/followers"
  ...
  Scenario: Get followers for non-existent user returns 404
    Given I have a request header "HTTP_ACCEPT" with value "application/json"
    And I request "GET" "/api/user/nonexistent/followers"
  ...
  # ---------------------------------------------------------------------------
  # GET /api/user/{id}/following — public endpoint
  # ---------------------------------------------------------------------------

  Scenario: Get following without auth returns 200
    Given I have a request header "HTTP_ACCEPT" with value "application/json"
    And I request "GET" "/api/user/1/following"
    Then the response status code should be "200"
    And the response should be in json format
    And the client response should contain "data"
    And the client response should contain "total_followers"
  ...
  Scenario: Get following for non-existent user returns 404
    Given I have a request header "HTTP_ACCEPT" with value "application/json"
    And I request "GET" "/api/user/nonexistent/following"
    Then the response status code should be "404"

  # ---------------------------------------------------------------------------
  # POST /api/user/{id}/follow — requires auth
  # ---------------------------------------------------------------------------

  Scenario: Follow without auth returns 401
    Given I have a request header "HTTP_ACCEPT" with value "application/json"
    And I request "POST" "/api/user/2/follow"
    Then the response status code should be "401"

  Scenario: Follow self returns 422
    Given I use a valid JWT Bearer token for "Catrobat"
    And I have a request header "HTTP_ACCEPT" with value "application/json"
    And I request "POST" "/api/user/1/follow"
    Then the response status code should be "422"

  Scenario: Follow non-existent user returns 404
    Given I use a valid JWT Bearer token for "Catrobat"
    And I have a request header "HTTP_ACCEPT" with value "application/json"
    And I request "POST" "/api/user/nonexistent/follow"
    Then the response status code should be "404"
  ...
  Scenario: Follow a new user returns 200
    Given I use a valid JWT Bearer token for "Catrobat"
    And I have a request header "HTTP_ACCEPT" with value "application/json"
    And I request "POST" "/api/user/3/follow"
    Then the response status code should be "200"

  # ---------------------------------------------------------------------------
  # DELETE /api/user/{id}/unfollow — requires auth
  # ---------------------------------------------------------------------------

  Scenario: Unfollow without auth returns 401
    Given I have a request header "HTTP_ACCEPT" with value "application/json"
    And I request "DELETE" "/api/user/2/unfollow"
    Then the response status code should be "401"

  Scenario: Unfollow self returns 422
    Given I use a valid JWT Bearer token for "Catrobat"
    And I have a request header "HTTP_ACCEPT" with value "application/json"
    And I request "DELETE" "/api/user/1/unfollow"
    Then the response status code should be "422"

  Scenario: Unfollow non-existent user returns 404
    Given I use a valid JWT Bearer token for "Catrobat"
    And I have a request header "HTTP_ACCEPT" with value "application/json"
    And I request "DELETE" "/api/user/nonexistent/unfollow"
    Then the response status code should be "404"
