@api
Feature: Get the most downloaded projects
  ...
  Scenario: show most downloaded projects with limit and offset
  ...
  Scenario: show only visible projects
    Given project "project 3" is not visible
    When I GET "/app/api/projects/mostViewed.json" with these parameters
    Then I should get projects in the following order:
      | Name      |
      | project 2 |
