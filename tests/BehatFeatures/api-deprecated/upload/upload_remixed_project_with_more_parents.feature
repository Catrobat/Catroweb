...
Feature: Upload a remixed project with multiple parents
  ...
  Catrobat language version 0.993 should correctly add remix relations
    ...
    And the uploaded project should have no Scratch parents, API version 1
    And the uploaded project should have no Catrobat forward descendants except self-relation, API version 1
    And the uploaded project should have RemixOf "Project 1 [/app/project/1], Project 8 [https://share.catrob.at/app/project/8]" in the xml, API version 1
  ...
  Catrobat language version 1 should correctly add remix relations (example #1)
    ...
    And the uploaded project should have no Scratch parents, API version 1
    And the uploaded project should have no Catrobat forward descendants except self-relation, API version 1
    And the uploaded project should have RemixOf "Project 2 [/pocketalice/project/2], Merge 1 [Project 7 [/app/project/7], Project 9 [https://share.catrob.at/app/project/9]]" in the xml, API version 1
  ...
  Catrobat language version 1.0 should correctly add remix relations (example #2)
    ...
    And the uploaded project should have no further Scratch parents, API version 1
    And the uploaded project should have no Catrobat forward descendants except self-relation, API version 1
    And the uploaded project should have RemixOf "The Colour Divide - Trailer [https://scratch.mit.edu/projects/70058680/], Merge 2 [Project 2 [/pocketalice/project/2], Merge 1 [Project 6 [/app/project/6], Project 8 [https://share.catrob.at/app/project/8]]]" in the xml, API version 1
