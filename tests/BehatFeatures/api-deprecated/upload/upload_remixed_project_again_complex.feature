...
Feature: Upload a remixed project with multiple parents
  ...
  Background:
    ...
    And there are projects:
      ...
      | 8  | project 8 |             | Catrobat | 133       | 33    | 01.01.2012 13:00 | 0.8.5   | true       |
  ...
  Scenario: reuploading project 2 with no parent-URLs should unlink all former remix ancestors (except self referencing relation)
    #-------------------------------------------------------------------------------------------------------------------
    ...
    #-------------------------------------------------------------------------------------------------------------------
    Given I am "Catrobat"
    Given I have a project with "name" set to "project 2" and "url" set to ""
    ...
    And the uploaded project should have a Catrobat forward ancestor having id "2" and depth "0", API version 1
    ...
    And the uploaded project should have a Catrobat forward descendant having id "3" and depth "1", API version 1
    And the uploaded project should have a Catrobat forward descendant having id "4" and depth "1", API version 1
    And the uploaded project should have a Catrobat forward descendant having id "5" and depth "2", API version 1
  ...
  remix ancestors (except self referencing relation)
    ...
    #-------------------------------------------------------------------------------------------------------------------
    Given I am "Catrobat"
    Given I have a project with "name" set to "project 2", "url" set to "Project 10 [/app/project/10], Project 11 [https://share.catrob.at/app/project/11]" and "catrobatLanguageVersion" set to "0.993"
    When I upload a generated project, API version 1
    Then the uploaded project should be a remix root, API version 1
    And the uploaded project should have remix migration date NOT NULL, API version 1
    And the uploaded project should have a Catrobat forward ancestor having id "2" and depth "0", API version 1
    ...
    And the uploaded project should have a Catrobat forward descendant having id "7" and depth "3", API version 1
    And the uploaded project should have no further Catrobat forward descendants, API version 1
    And the uploaded project should have RemixOf "Project 10 [/app/project/10], Project 11 [https://share.catrob.at/app/project/11]" in the xml, API version 1
  ...
  Catrobat remix ancestors (except self referencing relation)
    ...
    #-------------------------------------------------------------------------------------------------------------------
    Given I am "Catrobat"
    Given I have a project with "name" set to "project 2" and "url" set to "Music Inventor [https://scratch.mit.edu/projects/29495624]"
    When I upload a generated project, API version 1
    Then the uploaded project should be a remix root, API version 1
    And the uploaded project should have remix migration date NOT NULL, API version 1
    And the uploaded project should have a Catrobat forward ancestor having id "2" and depth "0", API version 1
    ...
    And the uploaded project should have a Catrobat forward descendant having id "7" and depth "3", API version 1
    And the uploaded project should have no further Catrobat forward descendants, API version 1
    And the uploaded project should have RemixOf "Music Inventor [https://scratch.mit.edu/projects/29495624]" in the xml, API version 1
  ...
  Scenario: reuploading project 2 with parent-URLs referring only to Scratch project but no valid Catrobat projects should
  unlink all former Catrobat remix ancestors (except self referencing relation)
    ...
    #-------------------------------------------------------------------------------------------------------------------
    Given I am "Catrobat"
    Given I have a project with "name" set to "project 2", "url" set to "Project 10 [/app/project/10], Music Inventor [https://scratch.mit.edu/projects/29495624]" and "catrobatLanguageVersion" set to "0.993"
    When I upload a generated project, API version 1
    Then the uploaded project should be a remix root, API version 1
    And the uploaded project should have remix migration date NOT NULL, API version 1
    And the uploaded project should have a Catrobat forward ancestor having id "2" and depth "0", API version 1
    ...
    And the uploaded project should have a Catrobat forward descendant having id "7" and depth "3", API version 1
    And the uploaded project should have no further Catrobat forward descendants, API version 1
    And the uploaded project should have RemixOf "Project 10 [/app/project/10], Music Inventor [https://scratch.mit.edu/projects/29495624]" in the xml, API version 1
  ...
  Scenario: reuploading project 4 with same parent-URLs should change remix graph
    #-------------------------------------------------------------------------------------------------------------------
    # this is how the remix graph should look like after the project is uploaded:
    #
    #             (1) (SCRATCH #1)                                    (1) (SCRATCH #1)
    ...
    #-------------------------------------------------------------------------------------------------------------------
    Given I am "Catrobat"
    Given I have a project with "name" set to "project 4", "url" set to "Project 2 [/app/project/2], Project 6 [/app/project/6]" and "catrobatLanguageVersion" set to "0.993"
    When I upload a generated project, API version 1
    ...
    And the uploaded project should have a Catrobat forward descendant having id "7" and depth "2", API version 1
    And the uploaded project should have no further Catrobat forward descendants, API version 1
    And the uploaded project should have RemixOf "Project 2 [/app/project/2], Project 6 [/app/project/6]" in the xml, API version 1
  ...
  Scenario: reuploading project 4 with parent-URLs referring only to its Catrobat forward ancestor (project 2) should
  unlink its Catrobat backward parent (project 6)
    #-------------------------------------------------------------------------------------------------------------------
    # this is how the remix graph should look like after the project is uploaded:
    #
    #             (1) (SCRATCH #1)                                    (1) (SCRATCH #1)
    ...
    #-------------------------------------------------------------------------------------------------------------------
    Given I am "Catrobat"
    Given I have a project with "name" set to "project 4" and "url" set to "Project 2 [/app/project/2]"
    When I upload a generated project, API version 1
    Then the uploaded project should not be a remix root, API version 1
    And the uploaded project should have remix migration date NOT NULL, API version 1
    And the uploaded project should have a Catrobat forward ancestor having id "4" and depth "0", API version 1
    ...
    And the uploaded project should have a Catrobat forward descendant having id "7" and depth "2", API version 1
    And the uploaded project should have no further Catrobat forward descendants, API version 1
    And the uploaded project should have RemixOf "Project 2 [/app/project/2]" in the xml, API version 1
  ...
  Scenario: reuploading project 4 with only backward parent (project 6) should only
  unlink all former Catrobat forward ancestors
    ...
    #-------------------------------------------------------------------------------------------------------------------
    Given I am "Catrobat"
    Given I have a project with "name" set to "project 4" and "url" set to "Project 6 [/app/project/6]"
    When I upload a generated project, API version 1
    Then the uploaded project should be a remix root, API version 1
    And the uploaded project should have remix migration date NOT NULL, API version 1
    And the uploaded project should have a Catrobat forward ancestor having id "4" and depth "0", API version 1
    ...
    And the uploaded project should have a Catrobat forward descendant having id "7" and depth "2", API version 1
    And the uploaded project should have no further Catrobat forward descendants, API version 1
    And the uploaded project should have RemixOf "Project 6 [/app/project/6]" in the xml, API version 1
  ...
  Scenario: reuploading project 3 with child project (project 6) as new parent should create backward relation
    #-------------------------------------------------------------------------------------------------------------------
    # this is how the remix graph should look like after the project is uploaded:
    #
    #             (1) (SCRATCH #1)                                    (1) (SCRATCH #1)
    ...
    #-------------------------------------------------------------------------------------------------------------------
    Given I am "Catrobat"
    Given I have a project with "name" set to "project 3" and "url" set to "Project 6 [/app/project/6]"
    When I upload a generated project, API version 1
    Then the uploaded project should be a remix root, API version 1
    And the uploaded project should have remix migration date NOT NULL, API version 1
    And the uploaded project should have a Catrobat forward ancestor having id "3" and depth "0", API version 1
    And the uploaded project should have no further Catrobat forward ancestors, API version 1
    And the uploaded project should have a Catrobat backward parent having id "6", API version 1
    And the uploaded project should have no further Catrobat backward parents, API version 1
    And the uploaded project should have no Scratch parents, API version 1
    And the uploaded project should have a Catrobat forward descendant having id "5" and depth "1", API version 1
    And the uploaded project should have a Catrobat forward descendant having id "6" and depth "1", API version 1
    And the uploaded project should have a Catrobat forward descendant having id "7" and depth "2", API version 1
    And the uploaded project should have no further Catrobat forward descendants, API version 1
    And the uploaded project should have RemixOf "Project 6 [/app/project/6]" in the xml, API version 1
  ...
  Scenario: reuploading project 3 with child project (project 6) as only parent should create backward relation and
  remove all former forward ancestors
    ...
    #-------------------------------------------------------------------------------------------------------------------
    Given I am "Catrobat"
    Given I have a project with "name" set to "project 3" and "url" set to "Project 7 [/app/project/7]"
    When I upload a generated project, API version 1
    Then the uploaded project should be a remix root, API version 1
    And the uploaded project should have remix migration date NOT NULL, API version 1
    And the uploaded project should have a Catrobat forward ancestor having id "3" and depth "0", API version 1
    ...
    And the uploaded project should have a Catrobat forward descendant having id "7" and depth "2", API version 1
    And the uploaded project should have no further Catrobat forward descendants, API version 1
    And the uploaded project should have RemixOf "Project 7 [/app/project/7]" in the xml, API version 1
  ...
  Scenario: reuploading project 2 with other Scratch project and child projects (project 6 and 7)
  as additional parents should create backward relations and replace old Scratch parent with new Scratch parent
    ...
    #-------------------------------------------------------------------------------------------------------------------
    Given I am "Catrobat"
    Given I have a project with "name" set to "project 2", "url" set to "Project 6[https://share.catrob.at/app/project/6],Project 7[/pocketalice/project/7/], Merge 1[Project 1 [/flavors/project/1], The Colour Divide - Trailer[https://scratch.mit.edu/projects/70058680]]" and "catrobatLanguageVersion" set to "0.993"
    When I upload a generated project, API version 1
    Then the uploaded project should not be a remix root, API version 1
    And the uploaded project should have remix migration date NOT NULL, API version 1
    And the uploaded project should have a Catrobat forward ancestor having id "2" and depth "0", API version 1
    ...
    And the uploaded project should have a Catrobat forward descendant having id "7" and depth "3", API version 1
    And the uploaded project should have no further Catrobat forward descendants, API version 1
    And the uploaded project should have RemixOf "Project 6[https://share.catrob.at/app/project/6],Project 7[/pocketalice/project/7/], Merge 1[Project 1 [/flavors/project/1], The Colour Divide - Trailer[https://scratch.mit.edu/projects/70058680]]" in the xml, API version 1
  ...
  Scenario: reuploading root project 2 becomes backward child of all of its child projects
    #-------------------------------------------------------------------------------------------------------------------
    # this is how the remix graph should look like after the project is uploaded:
    #
    #             (1) (SCRATCH #1)                                    (1) (SCRATCH #1)
    ...
    #
    #-------------------------------------------------------------------------------------------------------------------
    #  Expected result after upload: all Catrobat childs (2, 3, 4, 5, 6 and 7) become backward parent of project 1
    #-------------------------------------------------------------------------------------------------------------------
    Given I am "Catrobat"
    Given I have a project with "name" set to "project 1", "url" set to "project 1[/pocketalice/project/1],Merge 4 [project 7[/pocketalice/project/7], Merge3 [Project 6[/app/project/6], Merge 2[Project 5[https://share.catrob.at/app/project/5],Project 4[/pocketalice/project/4], Merge 1[Project 2 [/flavors/project/2], Project 3 [/flavors/project/3]]]]]" and "catrobatLanguageVersion" set to "0.993"
    When I upload a generated project, API version 1
    Then the uploaded project should be a remix root, API version 1
    And the uploaded project should have remix migration date NOT NULL, API version 1
    ...
    And the uploaded project should have a Catrobat backward parent having id "2", API version 1
    And the uploaded project should have a Catrobat backward parent having id "3", API version 1
    And the uploaded project should have a Catrobat backward parent having id "4", API version 1
    And the uploaded project should have a Catrobat backward parent having id "5", API version 1
    And the uploaded project should have a Catrobat backward parent having id "6", API version 1
    And the uploaded project should have a Catrobat backward parent having id "7", API version 1
    And the uploaded project should have no further Catrobat backward parents, API version 1
    And the uploaded project should have no Scratch parents, API version 1
    And the uploaded project should have a Catrobat forward descendant having id "2" and depth "1", API version 1
    And the uploaded project should have a Catrobat forward descendant having id "3" and depth "2", API version 1
    And the uploaded project should have a Catrobat forward descendant having id "4" and depth "2", API version 1
    And the uploaded project should have a Catrobat forward descendant having id "5" and depth "3", API version 1
    And the uploaded project should have a Catrobat forward descendant having id "6" and depth "2", API version 1
    And the uploaded project should have a Catrobat forward descendant having id "6" and depth "3", API version 1
    And the uploaded project should have a Catrobat forward descendant having id "7" and depth "3", API version 1
    And the uploaded project should have a Catrobat forward descendant having id "7" and depth "4", API version 1
    And the uploaded project should have no further Catrobat forward descendants, API version 1
    And the uploaded project should have RemixOf "project 1[/pocketalice/project/1],Merge 4 [project 7[/pocketalice/project/7], Merge3 [Project 6[/app/project/6], Merge 2[Project 5[https://share.catrob.at/app/project/5],Project 4[/pocketalice/project/4], Merge 1[Project 2 [/flavors/project/2], Project 3 [/flavors/project/3]]]]]" in the xml, API version 1
  ...
  Scenario: reuploading project 2 with new parent (project 9) should inherit all its forward relations
    #-------------------------------------------------------------------------------------------------------------------
    # this is how the remix graph should look like after the project is uploaded:
    #                                                                 (8)
    #                                                                  |
    ...
    #-------------------------------------------------------------------------------------------------------------------
    Given I am "Catrobat"
    Given I have a project with "name" set to "project 1" and "url" set to "project 9[/pocketalice/project/9]"
    When I upload a generated project, API version 1
    Then the uploaded project should not be a remix root, API version 1
    And the uploaded project should have remix migration date NOT NULL, API version 1
    And the uploaded project should have a Catrobat forward ancestor having id "1" and depth "0", API version 1
    ...
    And the uploaded project should have a Catrobat forward descendant having id "7" and depth "4", API version 1
    And the uploaded project should have no further Catrobat forward descendants, API version 1
    And the uploaded project should have RemixOf "project 9[/pocketalice/project/9]" in the xml, API version 1
  ...
  Scenario: reuploading project 6 with one less parent (project 3) should unlink only forward relation to project 3
  but not deeper forward relations since these forward relations (1-6 and 2-6) are still needed
    ...
    #-------------------------------------------------------------------------------------------------------------------
    Given I am "Catrobat"
    Given I have a project with "name" set to "project 6", "url" set to "Merge 1[Project 4 [/app/project/4], Project 2 [/app/project/2]],The Colour Divide - Trailer[https://scratch.mit.edu/projects/70058680]" and "catrobatLanguageVersion" set to "0.993"
    When I upload a generated project, API version 1
    Then the uploaded project should not be a remix root, API version 1
    And the uploaded project should have remix migration date NOT NULL, API version 1
    And the uploaded project should have a Catrobat forward ancestor having id "6" and depth "0", API version 1
    And the uploaded project should have a Catrobat forward ancestor having id "4" and depth "1", API version 1
    And the uploaded project should have a Catrobat forward ancestor having id "2" and depth "1", API version 1
    ...
    And the uploaded project should have no further Scratch parents, API version 1
    And the uploaded project should have no further Catrobat forward descendants, API version 1
    And the uploaded project should have RemixOf "Merge 1[Project 4 [/app/project/4], Project 2 [/app/project/2]],The Colour Divide - Trailer[https://scratch.mit.edu/projects/70058680]" in the xml, API version 1
  ...
  Scenario: reuploading project 6 with one less parent (project 3) should unlink all project 3's forward relations
  since they have different depth level than the ones still needed
    ...
    #-------------------------------------------------------------------------------------------------------------------
    Given I am "Catrobat"
    Given I have a project with "name" set to "project 6", "url" set to "Project 4 [/app/project/4],The Colour Divide - Trailer[https://scratch.mit.edu/projects/70058680]" and "catrobatLanguageVersion" set to "0.993"
    When I upload a generated project, API version 1
    Then the uploaded project should not be a remix root, API version 1
    And the uploaded project should have remix migration date NOT NULL, API version 1
    And the uploaded project should have a Catrobat forward ancestor having id "6" and depth "0", API version 1
    ...
    And the uploaded project should have no further Scratch parents, API version 1
    And the uploaded project should have no further Catrobat forward descendants, API version 1
    And the uploaded project should have RemixOf "Project 4 [/app/project/4],The Colour Divide - Trailer[https://scratch.mit.edu/projects/70058680]" in the xml, API version 1
  ...
  Scenario: reuploading project 6 with removed Scratch parent and with one less Catrobat parent (project 3) should
  unlink Scratch parent relation and also unlink all project 3's forward relations since they have different
  depth level than the ones still needed
    ...
    #-------------------------------------------------------------------------------------------------------------------
    Given I am "Catrobat"
    Given I have a project with "name" set to "project 6" and "url" set to "Project 4 [/app/project/4]"
    When I upload a generated project, API version 1
    Then the uploaded project should not be a remix root, API version 1
    And the uploaded project should have remix migration date NOT NULL, API version 1
    And the uploaded project should have a Catrobat forward ancestor having id "6" and depth "0", API version 1
    ...
    And the uploaded project should have no Scratch parents, API version 1
    And the uploaded project should have no further Catrobat forward descendants, API version 1
    And the uploaded project should have RemixOf "Project 4 [/app/project/4]" in the xml, API version 1
  ...
  Scenario: reuploading project 6 with no parents any more should convert former backward relation (6 -> 4)
  to a forward ancestor relation
    ...
    #-------------------------------------------------------------------------------------------------------------------
    Given I am "Catrobat"
    Given I have a project with "name" set to "project 6" and "url" set to ""
    When I upload a generated project, API version 1
    Then the uploaded project should be a remix root, API version 1
    And the uploaded project should have remix migration date NOT NULL, API version 1
    And the uploaded project should have a Catrobat forward ancestor having id "6" and depth "0", API version 1
  ...
  Scenario: multiple consecutive reuploads (example #1)
    ...
    Given I have a project with "name" set to "project 6" and "url" set to ""
    When I upload a generated project, API version 1
    And I upload another project with name set to "project 4" and url set to "Project 2[/app/project/2]", API version 1
    Then the uploaded project should not be a remix root, API version 1
    And the uploaded project should have remix migration date NOT NULL, API version 1
    And the uploaded project should have a Catrobat forward ancestor having id "4" and depth "0", API version 1
    And the uploaded project should have a Catrobat forward ancestor having id "1" and depth "2", API version 1
  ...
  Scenario: multiple consecutive reuploads (example #2)
    ...
    Given I have a project with "name" set to "project 6" and "url" set to ""
    When I upload a generated project, API version 1
    And I upload another project with name set to "project 4" and url set to "", API version 1
    Then the uploaded project should be a remix root, API version 1
    And the uploaded project should have remix migration date NOT NULL, API version 1
    And the uploaded project should have a Catrobat forward ancestor having id "4" and depth "0", API version 1
    And the uploaded project should have no Catrobat forward ancestors except self-relation, API version 1
  ...
  Scenario: multiple consecutive reuploads (example #3)
    ...
    Given I have a project with "name" set to "project 6" and "url" set to ""
    When I upload a generated project, API version 1
    And I upload another project with name set to "project 2", url set to "Project 1[/app/project/1],Music Inventor [https://scratch.mit.edu/projects/29495624]" and catrobatLanguageVersion set to "0.993", API version 1
    And I upload another project with name set to "project 4" and url set to "Project 2[/app/project/2]", API version 1
    Then the uploaded project should not be a remix root, API version 1
    And the uploaded project should have remix migration date NOT NULL, API version 1
    And the uploaded project should have a Catrobat forward ancestor having id "4" and depth "0", API version 1
    ...
    And the project "2" should have a Catrobat forward descendant having id "7" and depth "3"
    And the project "2" should have no further Catrobat forward descendants
    And the project "2" should have RemixOf "Project 1[/app/project/1],Music Inventor [https://scratch.mit.edu/projects/29495624]" in the xml
