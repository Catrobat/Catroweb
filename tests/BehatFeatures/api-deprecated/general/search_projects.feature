...
Feature: Search projects
  ...
  Scenario: search project by description
  ...
  Scenario: searching using the AND relation between the words should only show related projects
  ...
  Scenario: if the query matches in title and description, return the project with the matching title first
  ...
  Scenario: find a project with its id
  ...
  Scenario: only show visible projects
