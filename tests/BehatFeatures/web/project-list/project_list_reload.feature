...
Feature: Project list automatically loads more projects on scrolling
  ...
  Scenario: A project list is only initialized with 30 projects
    ...
    Then the "#home-projects__trending .projects-container" element should contain "project 01"
    ...
    And the "#home-projects__trending .projects-container" element should contain "project 34"
    ...
    And the "#home-projects__trending .projects-container" element should not contain "project 06"
    And the "#home-projects__trending .projects-container" element should not contain "project 07"
    And the "#home-projects__trending .projects-container" element should not contain "project 08"
    And the "#home-projects__trending .projects-container" element should not contain "project 09"
