...
Feature: Project list automatically loads more projects on scrolling
  ...
  Scenario: A project list is only initialized with 30 projects
    ...
    And the "#home-projects__trending .projects-container" element should not contain "project 31"
    And the "#home-projects__trending .projects-container" element should not contain "project 32"
    And the "#home-projects__trending .projects-container" element should not contain "project 33"
    And the "#home-projects__trending .projects-container" element should not contain "project 34"
