@admin
Feature: Admin approve projects
  ...
  Background:
    ...
    And there are projects:
      ...
      | 1  | project 1 | description1 | Catrobat | 01.01.2014 12:00 | 0.8.5   | 0.94             | true    |
      | 2  | project 2 | description2 | Catroweb | 22.04.2014 14:00 | 0.8.5   | 0.93             | true    |
      | 3  | project 3 | description3 | Catroweb | 22.04.2014 14:30 | 0.8.5   | 0.93             | true    |
      | 4  | project 4 |              | Catrobat | 22.04.2014 14:15 | 0.8.5   | 0.93             | true    |
      | 5  | project 5 | description2 | User1    | 22.04.2014 14:00 | 0.8.5   | 0.93             | false   |
  ...
  Scenario: List all projects:
    ...
    Then I should see the following not approved projects:
      ...
      | January 1, 2014 12:00 | 1  | Catrobat | project 1 | yes     | no       | Show   |
      | April 22, 2014 14:00  | 2  | Catroweb | project 2 | yes     | no       | Show   |
      | April 22, 2014 14:30  | 3  | Catroweb | project 3 | yes     | no       | Show   |
      | April 22, 2014 14:15  | 4  | Catrobat | project 4 | yes     | no       | Show   |
      | April 22, 2014 14:00  | 5  | User1    | project 5 | no      | no       | Show   |
  ...
  Scenario: Admin should be able to change the visibility of the project
    Given I log in as "Admin" with the password "123456"
    And I am on "/admin/approve/list"
    And I wait for the page to be loaded
