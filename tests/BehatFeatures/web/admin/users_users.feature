...
Feature: Admin featured programs
  ...
  Scenario: List users created between 01.01.2012 and 01.01.2014
    Given I log in as "Edmin" with the password "123456"
    And I am on "/admin/user/list?filter%5Busername%5D%5Btype%5D=&filter%5Busername%5D%5Bvalue%5D=&filter%5Bemail%5D%5Btype%5D=&filter%5Bemail%5D%5Bvalue%5D=&filter%5Bgroups%5D%5Btype%5D=&filter%5Bgroups%5D%5Bvalue%5D=&filter%5Benabled%5D%5Btype%5D=&filter%5Benabled%5D%5Bvalue%5D=&filter%5BcreatedAt%5D%5Btype%5D=&filter%5BcreatedAt%5D%5Bvalue%5D%5Bstart%5D=01.01.2012%2C+10%3A28%3A15&filter%5BcreatedAt%5D%5Bvalue%5D%5Bend%5D=01.01.2014%2C+10%3A28%3A04&filter%5B_page%5D=1&filter%5B_sort_by%5D=id&filter%5B_sort_order%5D=ASC&filter%5B_per_page%5D=32"
    And I wait for the page to be loaded
    Then I should see the user table:
      | username | email               | groups | enabled | createdAt               |
      | Superman | dev1@pocketcode.org |        | 1       | November 11, 2012 11:11 |
...
#    Given I log in as "Edmin" with the password "123456"
#    And I am on "/admin/user/list?filter%5Busername%5D%5Btype%5D=&filter%5Busername%5D%5Bvalue%5D=&filter%5Bemail%5D%5Btype%5D=&filter%5Bemail%5D%5Bvalue%5D=&filter%5Bgroups%5D%5Btype%5D=&filter%5Bgroups%5D%5Bvalue%5D=&filter%5Benabled%5D%5Btype%5D=&filter%5Benabled%5D%5Bvalue%5D=1&filter%5BcreatedAt%5D%5Btype%5D=&filter%5BcreatedAt%5D%5Bvalue%5D%5Bstart%5D=&filter%5BcreatedAt%5D%5Bvalue%5D%5Bend%5D=&filter%5B_page%5D=1&filter%5B_sort_by%5D=id&filter%5B_sort_order%5D=ASC&filter%5B_per_page%5D=32"
#    And I wait for the page to be loaded
#    Then I should see the user table:
#      | username  | email                | groups | enabled | createdAt               |
#      | Edmin     | admin@pocketcode.org |        | 1       | November 11, 2011 11:11 |
