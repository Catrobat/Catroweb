...
Feature: Admin all projects
  ...
  Scenario: Al projects should be sorted by upload date descending
    ...
    Then I should see the table with all projects in the following order:
      ...
      | April 22, 2019 13:00  | program 5 | Karim | pocketcode | 15    | 111       | no      | no       | no      | Show   |
      | April 6, 2019 13:02   | program 3 | Pauli | arduino    | 122   | 234       | no      | no       | no      | Show   |
      | April 2, 2019 13:10   | program 4 | Pauli | pocketcode | 12    | 222       | no      | no       | no      | Show   |
      | April 2, 2019 13:00   | program 2 | Karim | luna       | 921   | 123       | no      | no       | yes     | Show   |
  ...
  Scenario: Admin should be able to change the flavor of the project
    ...
    Then I should see the table with all projects in the following order:
      ...
      | April 6, 2019 13:02   | program 3 | Pauli | arduino    | 122   | 234       | no      | no       | no      | Show   |
      | April 2, 2019 13:10   | program 4 | Pauli | pocketcode | 12    | 222       | no      | no       | no      | Show   |
      | April 2, 2019 13:00   | program 2 | Karim | arduino    | 921   | 123       | no      | no       | yes     | Show   |
      | January 1, 2019 12:00 | program 1 | Karim | pocketcode | 120   | 3         | no      | no       | yes     | Show   |
