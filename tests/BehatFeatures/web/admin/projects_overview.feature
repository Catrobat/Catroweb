...
Feature: Admin all projects
  ...
  Background:
    ...
    And there are downloadable projects:
      ...
      | 1  | project 1 | a classy project | Karim    | 3         | pocketcode | 120   | 01.01.2019 12:00 | true    |
      | 2  | project 2 | abcef            | Karim    | 123       | luna       | 921   | 02.04.2019 13:00 | true    |
      | 3  | project 3 | description      | Pauli    | 234       | arduino    | 122   | 06.04.2019 13:02 | false   |
      | 4  | project 4 | abcdef           | Pauli    | 222       | pocketcode | 12    | 02.04.2019 13:10 | false   |
      | 5  | project 5 | abcd             | Karim    | 111       | pocketcode | 15    | 22.04.2019 13:00 | false   |
  ...
  Scenario: Al projects should be sorted by upload date descending
    ...
    Then I should see the table with all projects in the following order:
      | Uploaded At           | Name      | User  | Flavor     | Views | Downloads | private | Approved | Visible | Action |
      | April 22, 2019 13:00  | project 5 | Karim | pocketcode | 15    | 111       | no      | no       | no      | Show   |
      | April 6, 2019 13:02   | project 3 | Pauli | arduino    | 122   | 234       | no      | no       | no      | Show   |
      | April 2, 2019 13:10   | project 4 | Pauli | pocketcode | 12    | 222       | no      | no       | no      | Show   |
      | April 2, 2019 13:00   | project 2 | Karim | luna       | 921   | 123       | no      | no       | yes     | Show   |
      | January 1, 2019 12:00 | project 1 | Karim | pocketcode | 120   | 3         | no      | no       | yes     | Show   |
  ...
  Scenario: List all projects sorted by ute ascendin Pauli |g
    ...
    And I wait for the page to be loaded
    Then I should see the table with all projects in the following order:
      | Uploaded At           | User      | Name  | Flavor     | Views | Downloads | private | Approved | Visible | Action |
      | January 1, 2019 12:00 | project 1 | Karim | pocketcode | 120   | 3         | no      | no       | yes     | Show   |
      | April 2, 2019 13:00   | project 2 | Karim | luna       | 921   | 123       | no      | no       | yes     | Show   |
      | April 2, 2019 13:10   | project 4 | Pauli | pocketcode | 12    | 222       | no      | no       | no      | Show   |
      | April 6, 2019 13:02   | project 3 | Pauli | arduino    | 122   | 234       | no      | no       | no      | Show   |
  ...
  Scenario: Admin should be able to change the flavor of the project
    ...
    Then I should see the table with all projects in the following order:
      ...
      | April 6, 2019 13:02   | project 3 | Pauli | arduino    | 122   | 234       | no      | no       | no      | Show   |
      | April 2, 2019 13:10   | project 4 | Pauli | pocketcode | 12    | 222       | no      | no       | no      | Show   |
      | April 2, 2019 13:00   | project 2 | Karim | arduino    | 921   | 123       | no      | no       | yes     | Show   |
      | January 1, 2019 12:00 | project 1 | Karim | pocketcode | 120   | 3         | no      | no       | yes     | Show   |
...
#    And I report project 2 with category "spam" and note "Bad Project" in Browser
#    And I am on "/app"
#    And I wait for the page to be loaded
#    Then I should see "project 2"

  Scenario: Change the visibility of the project
    Given I log in as "Admin" with the password "123456"
    And I am on "/app"
    And I wait for the page to be loaded
  ...
  Scenario: Clicking on the show button should take me to the page with project details
    Given I log in as "Admin" with the password "123456"
    Given I am on "/admin/projects/list"
    And I wait for the page to be loaded
  ...
  Scenario: Clicking on the project name should take me to edit page of the project
    ...
    Given I am on "/admin/projects/list"
    And I wait for the page to be loaded
    And I click on the project name "project 5"
    And I wait for the page to be loaded
