...
Feature: As a visitor I want to see scratch projects
  ...
  Scenario: Visit a Scratch project
  ...
  Scenario: Visiting a not existing Scratch project
  ...
  Scenario: Visiting a Scratch project twice
    Given I request "GET" "/app/scratch/project/401650420"
    Then I should be redirected to a catrobat project
  ...
  Scenario: Visiting two Scratch projects made by the same user
    Given I request "GET" "/app/scratch/project/401650420"
    Then I should be redirected to a catrobat project
