...
Feature:
  ...
  Background:
    ...
    And there are media package files:
      ...
      | 3  | Galaxy     | Bla          | png       | 0      | 3.png      | luna       | Micheal John  |
      | 4  | Cat        | Animals      | png       | 1      | 4.png      | luna       |               |
      | 5  | Turtle     | Animals      | png       | 1      | 5.png      | pocketcode |               |
      | 6  | Bison      | Animals      | png       | 1      | 6.png      | pocketcode | Jenifer Shawn |
  ...
  Scenario: Selecting and deselecting media files for downloading
    Given I am on "/app/media-library/looks"
    And I wait for the page to be loaded
    And I click "#media-library-file-1"
    Then the element "#media-library-file-1" should have a attribute "class" with value "selected"
    And I click "#media-library-file-5"
    Then the element "#media-library-file-5" should have a attribute "class" with value "selected"
    ...
    And I click "#media-library-file-1"
    Then the element "#media-library-file-1" should have no attribute "class" with value "selected"
    And I click "#media-library-file-5"
    Then the element "#media-library-file-5" should have no attribute "class" with value "selected"
