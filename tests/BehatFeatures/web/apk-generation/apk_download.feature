Feature:
  ...
  Background:
    Given there are projects:
      ...
      | My little project | pending    | true    | 2  |
      | Bunny             | ready      | true    | 3  |
  ...
  Scenario:
    When I want to download the apk file of "My little project"
    Then the apk file will not be found

  Scenario: I should not be allowed to download the apk of an invisible project
