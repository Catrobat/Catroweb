...
class ExtractedCatrobatFileSpec extends ObjectBehavior
{
  ...
  {
    $this->shouldHaveType('App\Catrobat\Services\ExtractedCatrobatFile');
  }
  ...
  {
    $this->shouldThrow('App\Catrobat\Exceptions\InvalidCatrobatFileException')->during('__construct', [__SPEC_GENERATED_FIXTURES_DIR__ . 'program_with_missing_code_xml/', '/webpath', 'hash']);
  }

  public function it_throws_an_exception_when_code_xml_is_invalid()
  {
    $this->shouldThrow('App\Catrobat\Exceptions\InvalidCatrobatFileException')->during('__construct', [__SPEC_GENERATED_FIXTURES_DIR__ . 'program_with_invalid_code_xml/', '/webpath', 'hash']);
  }
