...
class VersionValidatorSpec extends ObjectBehavior
{
  ...
  {
    $this->shouldHaveType('App\Catrobat\Listeners\VersionValidator');
  }
  ...
  public function it_throws_an_exception_if_languageversion_is_too_old()
  {
    ...
    $this->shouldThrow('App\Catrobat\Exceptions\Upload\OldCatrobatLanguageVersionException')->duringValidate($xml);
  }
}
