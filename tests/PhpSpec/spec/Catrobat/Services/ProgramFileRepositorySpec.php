...
class ProgramFileRepositorySpec extends ObjectBehavior
{
  ...
  {
    $this->shouldHaveType('App\Catrobat\Services\ProgramFileRepository');
  }

  public function it_throws_an_exception_if_directory_is_not_found()
  {
    $this->shouldThrow('App\Catrobat\Exceptions\InvalidStorageDirectoryException')->during('__construct', [__DIR__ . '/invalid_directory/', '', new CatrobatFileCompressor(), $this->storage_dir . "tmp/"]);
  }
