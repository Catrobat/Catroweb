...
class ProgramManagerSpec extends ObjectBehavior
{
  ...
  /**
   * @param \AppBundle\Services\CatrobatFileExtractor $file_extractor          
   * @param \AppBundle\Services\ProgramFileRepository $file_repository          
   * @param \AppBundle\Services\ScreenshotRepository $screenshot_repository
   ...
   * @param \AppBundle\Model\Requests\AddProgramRequest $request          
   * @param \AppBundle\Model\ExtractedCatrobatFile $extracted_file          
  ...
  {
    $this->shouldHaveType('AppBundle\Model\ProgramManager');
  }
