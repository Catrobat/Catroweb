...
class ProgramManagerSpec extends ObjectBehavior
{
    ...
    public function it_returns_the_program_after_successfully_adding_a_program($request, $entity_manager)
    {
    ...
    public function it_saves_the_program_to_the_file_repository($request, $entity_manager, $extracted_file, $file_repository, $inserted_program)
    {
    ...
    public function it_saves_the_screenshots_to_the_screenshot_repository($request, $entity_manager, $extracted_file, $screenshot_repository, $inserted_program)
    {
    ...
    public function it_fires_an_event_before_inserting_a_program($request, $event_dispatcher)
    {
        $this->addProgram($request)->shouldHaveType('Catrobat\AppBundle\Entity\Program');
    ...
    public function it_fires_an_event_when_the_program_is_stored($request, $event_dispatcher)
    {
        $this->addProgram($request)->shouldHaveType('Catrobat\AppBundle\Entity\Program');
