...
class ScreenshotRepositorySpec extends ObjectBehavior
{
  ...
  {
    $this->shouldThrow('Catrobat\AppBundle\Exceptions\InvalidStorageDirectoryException')->during('__construct', [__DIR__ . '/invalid_directory/', '', $this->thumbnail_dir, '', $this->tmp_dir, '']);
  }

  public function it_throws_an_exception_if_given_an_valid_thumbnail_directory()
  {
    $this->shouldThrow('Catrobat\AppBundle\Exceptions\InvalidStorageDirectoryException')->during('__construct', [$this->screenshot_dir, '', __DIR__ . '/invalid_directory/', '', $this->tmp_dir, '']);
  }
