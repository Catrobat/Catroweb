...
class ProgramPermissionsListenerSpec extends ObjectBehavior
{
     ...
     */
    public function it_flags_a_program_as_phiro_if_phiro_permissions_are_used($program)
    {
     ...
     * @param \Catrobat\AppBundle\Entity\Program $program
     */
    public function it_does_not_flag_a_program_as_phiro_if_no_phiro_permissions_are_used($program)
    {
     ...
     */
    public function it_does_not_matter_at_which_line_the_permission_is_set($program, $program2)
    {
     ...
     * @param \Catrobat\AppBundle\Entity\Program $program
     */
    public function it_flags_a_program_as_lego_if_lego_permissions_are_used($program)
    {
     ...
     * @param \Catrobat\AppBundle\Entity\Program $program
     */
    public function it_does_not_flag_a_program_if_there_is_no_permissions_file($program)
    {
        $this->checkPermissions($this->file, $program);
        $program->setPhiro(Argument::exact(true))->shouldNotHaveBeenCalled();
        $program->setPhiro(Argument::exact(false))->shouldHaveBeenCalled();
